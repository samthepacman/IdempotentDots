...
myStartupHook :: X ()
myStartupHook = do
          spawnOnce "feh --no-fehbg --bg-fill ~/.config/nixpkgs/user/wallpaper/abstract/firewatch-blue.png"
          spawnOnce "picom &"
          spawnOnce "mpd"
          spawnOnce "xsetroot -cursor_name left_ptr &"
          setWMName "LG3D"
          spawnOnce "flashfocus -t 200 -o 0.7"
...
myShowWNameTheme = def
    { swn_font              = "xft:Iosevka:Heavy:size=28"
    , swn_fade              = 0.5
    , swn_bgcolor           = "#2E3440"
    , swn_color             = "#D8DEE9"
    }
